...
The scheduler now includes a few lightweight planning features:

- Sort tasks chronologically so the day's plan reads in time order even if tasks were entered out of order.
